...
class UserStatistics : public IUserStatistics {
    ...
    public:
    	UserStatistics(const std::vector<TDateTime> &_practiceTime, const std::map<wchar_t, KeyStatistics> &_keyStatistics);
...
extern "C" UserStatistics* DLL_EXPORT __stdcall CreateUserStatistics(const std::vector<TDateTime> &practiceTime, const std::map<wchar_t, KeyStatistics> &keyStatistics);
