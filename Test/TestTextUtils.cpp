...
void __fastcall TTestTextUtils::TestcountSentences()
{
	...
	int result = TextUtils::countSentences(L"Coding in C++ is  challenging! My favorite song is \"Smells Like Teen Spirit\" by Nirvana. \
...
void __fastcall TTestTextUtils::TestcountWords()
{
	...
	int result = TextUtils::countWords(L"The password must contain at least 8 characters, including !, #, or @.");
...
void __fastcall TTestTextUtils::TestcountChars()
{
	...
	int result = TextUtils::countChars(L"Hello, 123!");
	CheckEquals(10, result);

	int result2 = TextUtils::countChars(L"   Example	string.");
...
{
	UnicodeString result = TextUtils::trimSpaces(L"   Fast  &   Furious  ");
